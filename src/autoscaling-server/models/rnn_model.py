...
class RNN:
    ...
    def __build_model(self, features, labels, mode, params):
        ...
        cell = tf.nn.rnn_cell.MultiRNNCell(
            [self.__create_one_cell() for _ in range(num_layers)],
            state_is_tuple=True) if num_layers > 1 else self.__create_one_cell()
